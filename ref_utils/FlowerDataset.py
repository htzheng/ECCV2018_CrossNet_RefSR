...
class FlowerDataset(Dataset):
    ...
    def nextBatch_new(self, batchsize = 8, shuffle = False, view_mode = 'Random', specified_view = None, augmentation = False, offset_augmentation = False, index_inc = True, crop_shape = None,random_crop = False , SR=True, Dual = False):
        # nextBatch_new(batchsize = 8, shuffle = False, view_mode = 'Random', augmentation = False, index_inc = True)
        #       generate a dictionary that contains HR, LR and SR images of two views
        buff = dict()
        # init 
